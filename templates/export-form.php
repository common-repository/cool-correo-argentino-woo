...
<div class="coolca-form-search">
	<form action="" method="post" enctype="multipart/form-data" >
		...
		<label for="coolca_from_dt"><?php esc_html_e( 'Fecha desde: ', 'cool-ca' ); ?>
			<input type="date" name="coolca_from_dt" value="<?php echo esc_attr( $from_dt_dflt ); ?>" required/>
		</label>
		<label for="coolca_to_dt"><?php esc_html_e( 'a:', 'cool-ca' ); ?>
			<input type="date" name="coolca_to_dt" value="<?php echo esc_attr( $to_dt_dflt ); ?>" required/>
		</label>
		<label for="coolca_status"><?php esc_html_e( 'Estado:', 'cool-ca' ); ?>
		...
		<label for="coolca_include_free"><?php esc_html_e( 'Incluir Método Envío Gratuito:', 'cool-ca' ); ?>
